...
ActiveRecord::Base.transaction do
  ...
  project2.save
  user3 = User.new(name: "Maurice Ribble", email: "mauriceribble@gmail.com", password: "starwars", biography: "Maurice is an inventor and engineer. He enjoys understanding fragments of the universe and solving problems he encounters.", websites: nil, google_analytics: nil)
  ...
  project3.save
  user4 = User.new(name: "Mira Ong Chua", email: "miraongchua@gmail.com", password: "starwars", biography: "comic artist", websites: nil, google_analytics: nil)
  ...
  project4.save
  user5 = User.new(name: "Hiveworks Comics", email: "hiveworkscomics@gmail.com", password: "starwars", biography: "Hiveworks Comics is a creator-owned published and studio dedicated to distributing and promoting wonderful stories to an online audience.", websites: nil, google_analytics: nil)
  ...
  project7.save
  user8 = User.new(name: "PvP Online", email: "pvponline@gmail.com", password: "starwars", biography: "PvP Online is an Eisner and Harvey award winning comic created by cartoonist Scott Kurtz. First appearing online May 4th, 1998 it has become one of the most prominent and longest running pop-culture related webcomics on the internet.", websites: nil, google_analytics: nil)
  ...
  project9.save
  user10 = User.new(name: "Labyrinth", email: "labyrinth@gmail.com", password: "starwars", biography: "A boy with a dream to make video games.", websites: nil, google_analytics: nil)
  ...
  project10.save
  user11 = User.new(name: "Triton Noir", email: "tritonnoir@gmail.com", password: "starwars", biography: "Triton Noir is an independent studio creating and publishing board games. Founded in 2014, we are located in Montréal.", websites: nil, google_analytics: nil)
  ...
  project16.save
  user17 = User.new(name: "Amy Nazer", email: "amynazer@gmail.com", password: "starwars", biography: "Aspiring mad scientist making flavor extracts for cooking, baking, and cocktails", websites: nil, google_analytics: nil)
  ...
  project17.save
  user18 = User.new(name: "Joyce Zhu", email: "joycezhu@gmail.com", password: "starwars", biography: "My mother and I make all-natural milk chews, milk-based chewy snacks influenced by an Asian treat my mother grew up eating. We love traveling, discovering good food, and hiking.", websites: nil, google_analytics: nil)
  ...
  project19.save
  user20 = User.new(name: "Electric Six", email: "electricsix@gmail.com", password: "starwars", biography: "We are a rock band from Detroit, Michigan. Much as we might like to, we can't take you to a gay bar.", websites: nil, google_analytics: nil)
  ...
  project36.save
  user37 = User.new(name: "Jack Harries & Geordie Cargill", email: "jackharriesgeordiecargill@gmail.com", password: "starwars", biography: "Chief Directors and Editors.", websites: nil, google_analytics: nil)
  ...
  project38.save
  user39 = User.new(name: "Playeress", email: "playeress@gmail.com", password: "starwars", biography: "Women powered board games. Meaningful, inspiring and durable.", websites: nil, google_analytics: nil)
  ...
  project41.save
  user42 = User.new(name: "Wyatt J Hesemeyer", email: "wyattjhesemeyer@gmail.com", password: "starwars", biography: "Wyatt J Hesemeyer is a visual artists based out of northern California. His primary mediums are tattoo art, and pen and ink.", websites: nil, google_analytics: nil)
  ...
  project42.save
  user43 = User.new(name: "John Betancourt", email: "johnbetancourt@gmail.com", password: "starwars", biography: "John Betancourt runs Wildside Press, an independent publishing company. He is also a best-selling science fiction and fantasy writer, and an award-winning mystery writer.", websites: nil, google_analytics: nil)
  ...
  project43.save
  user44 = User.new(name: "Ben Tibbetts", email: "bentibbetts@gmail.com", password: "starwars", biography: "Ben Tibbetts is a professional adventure photographer, artist and IFMGA mountain guide. He specialises in working in remote and cold environments and has climbed and skied new routes in Antarctica, Greenland, Kyrgyzstan and the Alps.", websites: nil, google_analytics: nil)
  ...
  project44.save
  user45 = User.new(name: "Paper Hat, Inc.", email: "paperhatinc@gmail.com", password: "starwars", biography: "Paper Hat is a print studio and gallery run by Chicago printers Elizabeth Kovach and Ryan Duggan.", websites: nil, google_analytics: nil)
