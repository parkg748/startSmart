...
#     json.extract! project, :id, :title, :description, :duration, :pledge_amt, :eta, :shipping, :limit, :city, :state, :country, :funding_goal, :category_id, :user_id, :subcategory, :challenges
#     json.imageUrl url_for(project.image_url)
#   end
# end
