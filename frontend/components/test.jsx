      ...
      <div>
        <div class="pieContainer">
          <div class="pieBackground">
            ...
            <div class="hand13"></div>
            <div class="hand14"></div>
            <div class="hand15"></div>
            ...
            <div id="pieSlice14" class="hold"><div class="pie"></div></div>
            <div id="pieSlice15" class="hold"><div class="pie"></div></div>
          </div>
        </div>
      </div>
    );
