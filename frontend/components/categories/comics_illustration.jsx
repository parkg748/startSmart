              ...
              <div className='explore-theater-inner-inner'>
                ...
                <div className='explore-theater-columns'>
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectComics[0] && comicsUsersProjects[0] ? `/users/${comicsUsersProjects[0].id}/projects/${projectComics[0].id}` : '/'}><img src={projectComics[0] ? projectComics[0].imageUrl : ''}/></Link>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectComics[1] && comicsUsersProjects[1] ? `/users/${comicsUsersProjects[1].id}/projects/${projectComics[1].id}` : '/'}><img src={projectComics[1] ? projectComics[1].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectComics[2] && comicsUsersProjects[2] ? `/users/${comicsUsersProjects[2].id}/projects/${projectComics[2].id}` : '/'}><img src={projectComics[2] ? projectComics[2].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectComics[3] && comicsUsersProjects[3] ? `/users/${comicsUsersProjects[3].id}/projects/${projectComics[3].id}` : '/'}><img src={projectComics[3] ? projectComics[3].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
          ...
          <div className='explore-theater'>
            <div className='explore-theater-inner'>
              <div className='explore-theater-inner-inner'>
                ...
                <div className='explore-theater-columns'>
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[0] && lgbtqUsersProjects[0] ? `/users/${lgbtqUsersProjects[0].id}/projects/${projectLGBTQ[0].id}` : '/'}><img src={projectLGBTQ[0] ? projectLGBTQ[0].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[1] && lgbtqUsersProjects[1] ? `/users/${lgbtqUsersProjects[1].id}/projects/${projectLGBTQ[1].id}` : '/'}><img src={projectLGBTQ[1] ? projectLGBTQ[1].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[2] && lgbtqUsersProjects[2] ? `/users/${lgbtqUsersProjects[2].id}/projects/${projectLGBTQ[2].id}` : '/'}><img src={projectLGBTQ[2] ? projectLGBTQ[2].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[3] && lgbtqUsersProjects[3] ? `/users/${lgbtqUsersProjects[3].id}/projects/${projectLGBTQ[3].id}` : '/'}><img src={projectLGBTQ[3] ? projectLGBTQ[3].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
          ...
          <div className='explore-theater'>
            <div className='explore-theater-inner'>
              <div className='explore-theater-inner-inner'>
                ...
                <div className='explore-theater-columns'>
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectIllustration[0] && illustrationUsersProjects[0] ? `/users/${illustrationUsersProjects[0].id}/projects/${projectIllustration[0].id}` : '/'}><img src={projectIllustration[0] ? projectIllustration[0].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectIllustration[1] && illustrationUsersProjects[1] ? `/users/${illustrationUsersProjects[1].id}/projects/${projectIllustration[1].id}` : '/'}><img src={projectIllustration[1] ? projectIllustration[1].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectIllustration[2] && illustrationUsersProjects[2] ? `/users/${illustrationUsersProjects[2].id}/projects/${projectIllustration[2].id}` : '/'}><img src={projectIllustration[2] ? projectIllustration[2].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectIllustration[3] && illustrationUsersProjects[3] ? `/users/${illustrationUsersProjects[3].id}/projects/${projectIllustration[3].id}` : '/'}><img src={projectIllustration[3] ? projectIllustration[3].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
          ...
          <div className='explore-theater'>
            <div className='explore-theater-inner'>
              <div className='explore-theater-inner-inner'>
                ...
                <div className='explore-theater-columns'>
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectComics[4] && comicsUsersProjects[4] ? `/users/${comicsUsersProjects[4].id}/projects/${projectComics[4].id}` : '/'}><img src={projectComics[4] ? projectComics[4].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[5] && lgbtqUsersProjects[5] ? `/users/${lgbtqUsersProjects[5].id}/projects/${projectLGBTQ[5].id}` : '/'}><img src={projectLGBTQ[5] ? projectLGBTQ[5].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[6] && lgbtqUsersProjects[6] ? `/users/${lgbtqUsersProjects[6].id}/projects/${projectLGBTQ[6].id}` : '/'}><img src={projectLGBTQ[6] ? projectLGBTQ[6].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
                  ...
                  <div className='explore-theater-column'>
                    <Link className='explore-theater-column-image' to={projectLGBTQ[7] && lgbtqUsersProjects[7] ? `/users/${lgbtqUsersProjects[7].id}/projects/${projectLGBTQ[7].id}` : '/'}><img src={projectLGBTQ[7] ? projectLGBTQ[7].imageUrl : ''}/></Link>
                    <div className='explore-theater-column-grey-bar'>
                      <div className='explore-theater-column-green-bar'></div>
                    </div>
